# ------------------------------------------------------------------------
# Copyright (c) 2021 Zhejiang University. All Rights Reserved.
# ------------------------------------------------------------------------
# ------------------------------------------------------------------------
...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default='/data/cmpe258-sp24/jingshu/GroupProjectDatasets/coco/', type=str)
...
def main(args):
    ...
    datasets = ['e2e_mot', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint', 'Text', 'VideoText']
...
#         sampler_val = torch.utils.data.SequentialSampler(dataset_val)
    ...
    if args.dataset_file in ['e2e_mot', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint', 'Text', 'VideoText']:
...
#         base_ds = get_coco_api_from_dataset(dataset_val)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            if (epoch + 1) % args.lr_drop == 0 or (epoch + 1) % args.save_period == 0 or (((epoch + 1 > 30) or args.epochs < 100) and (epoch + 1) % 1 == 0):
